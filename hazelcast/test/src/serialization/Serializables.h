...
struct TestDataSerializable
{
    ...
    friend bool operator==(const TestDataSerializable& lhs,
                           const TestDataSerializable& rhs);
...
struct TestNamedPortable
{
    ...
    friend bool operator==(const TestNamedPortable& lhs,
                           const TestNamedPortable& rhs);
};
...
struct TestRawDataPortable
{
    ...
    friend bool operator==(const TestRawDataPortable& lhs,
                           const TestRawDataPortable& rhs);
};
...
struct TestInnerPortable
{
    ...
    friend bool operator==(const TestInnerPortable& lhs,
                           const TestInnerPortable& rhs);
};
...
struct TestMainPortable
{
    ...
    friend bool operator==(const TestMainPortable& lhs,
                           const TestMainPortable& rhs);
};
...
struct TestNamedPortableV2
{
    ...
    friend bool operator==(const TestNamedPortableV2& lhs,
                           const TestNamedPortableV2& rhs);
};
...
struct TestCustomXSerializable
{
    ...
    friend bool operator==(const TestCustomXSerializable& lhs,
                           const TestCustomXSerializable& rhs);
};
...
struct TestCustomPerson
{
    ...
    friend bool operator==(const TestCustomPerson& lhs,
                           const TestCustomPerson& rhs);
};
...
struct ObjectCarryingPortable
{
    ...
    friend bool operator==(const ObjectCarryingPortable& lhs,
                           const ObjectCarryingPortable& rhs)
    {
...
struct ChildTemplatedPortable1
{
    ...
    friend bool operator==(const ChildTemplatedPortable1& lhs,
                           const ChildTemplatedPortable1& rhs);
};
...
struct ChildTemplatedPortable2
{
    ...
    friend bool operator==(const ChildTemplatedPortable2& lhs,
                           const ChildTemplatedPortable2& rhs);
};
} // namespace test
...
struct hz_serializer<test::employee> : public portable_serializer
{
    ...
    static void write_portable(const test::employee& object,
...
template<>
struct hz_serializer<test::EmployeeEntryComparator>
  : public identified_data_serializer
{
    ...
    static void write_data(const test::EmployeeEntryComparator& object,
...
template<>
struct hz_serializer<test::EmployeeEntryKeyComparator>
  : public identified_data_serializer
{
    static int32_t get_factory_id();
    ...
    static test::EmployeeEntryKeyComparator read_data(
...
struct hz_serializer<test::TestMainPortable> : public portable_serializer
{
    ...
    static void write_portable(const test::TestMainPortable& object,
                               portable_writer& writer);
...
struct hz_serializer<test::TestRawDataPortable> : public portable_serializer
{
    ...
    static void write_portable(const test::TestRawDataPortable& object,
                               portable_writer& writer);
...
template<>
struct hz_serializer<test::TestDataSerializable>
  : public identified_data_serializer
{
    static int32_t get_factory_id();
    ...
    static void write_data(const test::TestDataSerializable& object,
...
struct hz_serializer<test::TestInnerPortable> : public portable_serializer
{
    ...
    static void write_portable(const test::TestInnerPortable& object,
                               portable_writer& writer);
...
struct hz_serializer<test::TestNamedPortable> : public portable_serializer
{
    ...
    static void write_portable(const test::TestNamedPortable& object,
                               portable_writer& writer);
...
template<>
struct hz_serializer<test::TestNamedPortableV2>
  : public versioned_portable_serializer
{
    static int32_t get_factory_id();
    ...
    static void write_portable(const test::TestNamedPortableV2& object,
                               portable_writer& writer);
...
template<>
struct hz_serializer<test::TestNamedPortableV3>
  : public versioned_portable_serializer
{
    static int32_t get_factory_id();
    ...
    static void write_portable(const test::TestNamedPortableV3& object,
                               portable_writer& writer);
...
template<>
struct hz_serializer<test::TestInvalidWritePortable>
  : public portable_serializer
{
    ...
    static test::TestInvalidWritePortable read_portable(
...
template<typename P>
struct hz_serializer<test::ObjectCarryingPortable<P>>
  : public portable_serializer
{
    static int32_t get_factory_id()
    {
    ...
    {
        return static_cast<int32_t>(
          test::test_serialization_constants::OBJECT_CARRYING_PORTABLE);
    }
    ...
    static test::ObjectCarryingPortable<P> read_portable(
      portable_reader& reader)
    {
        object_data_input& input = reader.get_raw_data_input();
        return test::ObjectCarryingPortable<P>{
            input.read_object<P>().value()
        };
    }
};
...
template<typename P>
struct hz_serializer<test::ParentTemplatedPortable<P>>
  : public portable_serializer
{
    static int32_t get_factory_id()
    {
    ...
    {
        return static_cast<int32_t>(
          test::test_serialization_constants::PARENT_TEMPLATED_CONSTANTS);
    }

    static void write_portable(const test::ParentTemplatedPortable<P>& object,
                               portable_writer& out)
    {
...
struct hz_serializer<test::TestCustomPerson> : public custom_serializer
{
    ...
    static void write(const test::TestCustomPerson& object,
                      object_data_output& out);
...
struct hz_serializer<test::TestCustomXSerializable> : public custom_serializer
{
    ...
    static void write(const test::TestCustomXSerializable& object,
                      object_data_output& out);
