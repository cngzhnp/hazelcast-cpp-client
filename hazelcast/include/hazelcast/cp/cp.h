...
public:
    ...
    boost::future<std::optional<R>> apply(const F& function)
    {
        auto f = to_data(function);
...
private:
    ...
    boost::future<std::optional<client::serialization::pimpl::data>>
...
public:
    ...
    template<typename T>
    boost::future<std::optional<typename std::remove_pointer<T>::type>> get()
    {
        return to_object<typename std::remove_pointer<T>::type>(get_data());
    }

    template<typename T>
    boost::future<std::optional<typename std::remove_pointer<T>::type>> set(
      T new_value)
    {
    ...
    template<typename T>
    boost::future<std::optional<typename std::remove_pointer<T>::type>>
...
private:
    ...
    boost::future<std::optional<client::serialization::pimpl::data>> set_data(
