...
public:
    ...
    read_result_set(
      ...
      std::optional<std::vector<int64_t>>& item_seqs,
      int64_t next_seq)
     ...
     *
     * @return the sequence of the item following the last item in the result
     * set
     * @since 3.10
     */
...
private:
    ...
    std::optional<std::vector<int64_t>> item_seqs_;
    int64_t next_seq_;
};
} // namespace rb
} // namespace client
