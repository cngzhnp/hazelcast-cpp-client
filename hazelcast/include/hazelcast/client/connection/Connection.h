...
public:
    ...
    const std::optional<address>& get_remote_address() const;

    void set_remote_address(std::optional<address> endpoint);
    ...
    std::optional<address> get_local_socket_address() const;
...
private:
    ...
    std::optional<address> remote_address_;
