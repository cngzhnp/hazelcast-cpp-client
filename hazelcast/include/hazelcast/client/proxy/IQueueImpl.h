...
protected:
    ...
    boost::future<boost::uuids::uuid> add_item_listener(
      std::unique_ptr<impl::item_event_handler<
        protocol::codec::queue_addlistener_handler>>&& item_event_handler,
      bool include_value)
    {
    ...
    boost::future<std::optional<serialization::pimpl::data>> take_data();

    boost::future<std::optional<serialization::pimpl::data>> peek_data();
