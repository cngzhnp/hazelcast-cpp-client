...
public:
    ...
    boost::future<std::optional<V>> get(const K& key)
    {
    ...
    boost::future<std::optional<R>> put(const K& key, const V& value)
    {
     ...
     */
    template<typename K, typename V, typename R = V>
    boost::future<std::optional<R>> put(const K& key,
                                          const V& value,
     ...
     */
    template<typename K, typename V>
    boost::future<std::optional<V>> remove(const K& key)
    {
     ...
     */
    template<typename K, typename V, typename R = V>
    boost::future<std::optional<V>> put_if_absent(const K& key,
                                                    const V& value)
    {
     ...
     */
    template<typename K, typename V, typename R = V>
    boost::future<std::optional<R>> replace(const K& key, const V& value)
    {
    ...
    */
     ...
     */
    template<typename K, typename V>
    boost::future<std::optional<entry_view<K, V>>> get_entry_view(
      const K& key)
    {
    ...
    boost::future<std::optional<ResultType>> execute_on_key(
      const K& key,
     ...
     */
    template<typename K, typename ResultType, typename EntryProcessor>
    boost::future<std::optional<ResultType>> submit_to_key(
      const K& key,
      const EntryProcessor& entry_processor)
    {
        return to_object<ResultType>(
     ...
     */
    template<typename K, typename ResultType, typename EntryProcessor>
    boost::future<std::unordered_map<K, std::optional<ResultType>>>
...
protected:
    ...
    virtual boost::future<std::optional<serialization::pimpl::data>>
...
private:
    template<typename K, typename V>
    std::vector<std::pair<K, std::optional<V>>> sort_and_get(
      query::paging_predicate<K, V>& predicate,
      query::iteration_type iteration_type,
      std::vector<std::pair<K, V>> entries)
    {
        std::vector<std::pair<K, std::optional<V>>> optionalEntries;
      ...
      std::vector<std::pair<K, std::optional<V>>> entries)
    {
        std::sort(entries.begin(),
                  entries.end(),
                  [&](const std::pair<K, std::optional<V>>& lhs,
                      const std::pair<K, std::optional<V>>& rhs) {
        ...
        std::vector<std::pair<K, std::optional<V>>> result;
