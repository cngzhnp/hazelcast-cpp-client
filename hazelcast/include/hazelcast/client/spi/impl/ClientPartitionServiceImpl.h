...
public:
    ...
    /**
     * The partitions can be empty on the response, client will not apply the
    ...
    std::shared_ptr<client::impl::Partition> get_partition(
...
private:
    ...
    public:
        ...
        std::optional<member> get_owner() const override;
