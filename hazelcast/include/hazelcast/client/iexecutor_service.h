...
public:
    ...
    public:
        ...
        executor_promise(
          boost::future<std::optional<T>>& future,
        ...
        boost::shared_future<std::optional<T>> get_future()
        {
            return shared_future_;
        }

    private:
        boost::shared_future<std::optional<T>> shared_future_;
     ...
     *
     * @param command        the task that is executed on a randomly selected
     * member
    ...
    /**
     * Submits a task to the owner of the specified key and returns a
     * executor_promise representing that task.
     *
     ...
     * map of Member-executor_promise pairs representing pending completion of
     * the task on each member
     *
     * @param task    the task submitted to given members
     * @param members the given members
     * @param <T>     the result type of callable
     * @return map of Member-executor_promise pairs representing pending
     * completion of the task on each member
     */
    template<typename HazelcastSerializable, typename T>
     ...
     * representing that task. The executor_promise's {@code
     * executor_promise::get} method will return the given result upon
    ...
    /**
     * Submits a task to a randomly selected member and returns a
     * executor_promise representing that task.
     *
