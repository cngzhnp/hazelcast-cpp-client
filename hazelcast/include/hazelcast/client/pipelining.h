...
public:
     ...
     */
    std::vector<std::optional<E>> results()
    {
        std::vector<std::optional<E>> result;
     ...
     */
    void add(boost::future<std::optional<E>> future)
    {
        down();
...
private:
    ...
    int permits_;
    std::vector<boost::shared_future<std::optional<E>>> futures_;
};
} // namespace client
} // namespace hazelcast
