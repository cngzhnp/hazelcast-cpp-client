...
public:
     ...
     */
    template<typename E>
    boost::future<std::optional<E>> get(int32_t index)
    {
    ...
    boost::future<std::optional<R>> set(int32_t index, const E& element)
    {
        return to_object<R>(
     ...
     */
    template<typename E>
    boost::future<std::optional<E>> remove(int32_t index)
    {
